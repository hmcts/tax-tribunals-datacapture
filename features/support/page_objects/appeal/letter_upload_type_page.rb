class LetterUploadTypePage < BasePage
  ...
  section :content, '#main-content' do
    ...
    element :one_doc_option, 'label',
            text: I18n.t('helpers.label.steps_details_letter_upload_type_form.letter_upload_type_options.single_test')
    element :multiple_pages, 'label',
            text: I18n.t('helpers.label.steps_details_letter_upload_type_form.letter_upload_type_options.multiple_test')
    element :no_letter, 'label',
            text: I18n.t('helpers.label.steps_details_letter_upload_type_form.letter_upload_type_options.no_letter_test')
