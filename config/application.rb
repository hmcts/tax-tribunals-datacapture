...
require_relative '../app/middleware/strict_transport_security_middleware' # TEMP UNREMOVAL - 22 Jan
...
module TaxTribunalsDatacapture
  class Application < Rails::Application
    ...
    config.middleware.use StrictTransportSecurityMiddleware # TEMP UNREMOVAL - 22 Jan
