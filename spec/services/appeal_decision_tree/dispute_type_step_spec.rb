  ...
  subject { described_class.new(tribunal_case:, step_params:, next_step:) }
	...
	context 'when the step is `dispute_type`' do
		...
		context 'and the dispute type should not ask for a penalty or tax amount but the dispute_type asks hardship and the case_type asks hardship' do
			let(:dispute_type) {
 instance_double(DisputeType, ask_penalty?: false, ask_tax?: false, ask_penalty_and_tax?: false, ask_hardship?: true) }
 ...
 instance_double(DisputeType, ask_penalty?: false, ask_tax?: false, ask_penalty_and_tax?: false, ask_hardship?: true) }
      ...
      it { is_expected.to have_destination('steps/lateness/in_time', :edit) }
		...
		context 'and the dispute type should not ask for a penalty amount, tax amount or hardship' do
			let(:dispute_type) {
 instance_double(DisputeType, ask_penalty?: false, ask_tax?: false, ask_penalty_and_tax?: false, ask_hardship?: false) }
